...
//             const response = await api.post('get_usesr_attendance_list',{"rmb_user_id": 61});
//             const data = await response.data.data || [];

//             console.log(data,'My meetings data');
//             // setMeetingsData(response.data);
//             // For demo purpose, we are using static data
...
//                             />
//                             <View>
//                                 <Text style={styles.meetingTitle} numberOfLines={2}>{meeting?.meet_venue ?? 'Lahospin'}</Text>
//                                 <View style={styles.timeRow}>
//                                     <Icon name="clock" size={16} color="#888" />
//                                     <Text style={styles.timeText}>{meeting?.attend_time}</Text>
//                                     <MaterialIcons name="calendar-today" size={16} color="#888" style={{ marginLeft: 10 }} />
//                                     <Text style={styles.timeText}>{meeting?.attend_date ?? 'N/A'}</Text>
//                                 </View>
//                             </View>
//                         </View>
