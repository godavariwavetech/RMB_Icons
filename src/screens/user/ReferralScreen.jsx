...
const ReferralScreen = () => {
    ...
    const [userData,setUserData] = useState({id: 1, name: 'Mahesh', phone: '9876501234', email: 'mahesh@example.com', address: 'Vizag'});
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 8 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={{ padding: 16, paddingTop: 24 }}>
                    ...
                    <View style={[styles.inputIconWrapper, { height: 80, alignItems: 'flex-start' }]}>
                        <Feather name="message-square" size={16} color="#888" style={{ marginTop: 12 }} />
                        <TextInput
